...
/**
 * Template class of the incremental learner (CIL) algorithm, which was published in
 ...
 *
 * In this template, we define two main variants of CIL:
...
public class IL {
    ...
    private BLFM_IncLearnerMax incLearner;

    public IL(Flexibility flexibility,
              long seed,
              int nVbemCandidates) {
        ...
        switch (flexibility) {
            ...
            case HIGH: initializeHigh(iterationGlobalVBEM, initialVBEMConfig, localVBEMConfig, iterationVBEMConfig,
                    finalVBEMConfig, typeLocalVBEM);
                break;

            case MEDIUM: initializeMedium(iterationGlobalVBEM, initialVBEMConfig, localVBEMConfig, iterationVBEMConfig,
                    finalVBEMConfig, typeLocalVBEM);
                break;

            case LOW: initializeLow(iterationGlobalVBEM, initialVBEMConfig, localVBEMConfig, iterationVBEMConfig,
                    finalVBEMConfig, typeLocalVBEM);
                break;
        }
    }
    ...
    public Tuple2<BayesianNetwork, Double> learnModel(DataOnMemory<DataInstance> data,
        ...
        Result result = this.incLearner.learnModel(data, priors, logLevel);
    ...
    private void initializeHigh(boolean iterationGlobalVBEM,
        ...
        this.incLearner = new BLFM_IncLearnerMax(operators, iterationGlobalVBEM, initialVBEMConfig, localVBEMConfig,
                iterationVBEMConfig, finalVBEMConfig, typeLocalVBEM);
    }
