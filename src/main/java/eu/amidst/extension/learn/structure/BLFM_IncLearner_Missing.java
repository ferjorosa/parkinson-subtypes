...
/** Esta es una version del CIL que permite missing values, en cada iteracion se actualizan los MIs */
...
public class BLFM_IncLearner_Missing {
    ...
    public BLFM_IncLearner_Missing(Set<BlfmIncOperator> operators,
    ...
    public Result learnModel(DataOnMemory<DataInstance> data, int alpha, Map<String, double[]> priors, LogUtils.LogLevel logLevel) {
        ...
        /* Completamos los datos con los expected values para poder calcular sus MIs */
        DataOnMemory<DataInstance> completeDataForMI = ImputeMissing.imputeWithExpectedValue(data);
         ...
         */
        double[][] mis = MutualInformation.estimate(completeDataForMI, this.n_neighbors_mi, this.distanceFunction_mi, this.gaussianNoise_mi, this.gaussianNoiseSeed, this.normalizedMI);
        ...
        initializeDataForMI(currentDataForMI, completeDataForMI, variables);
