...
public class VMPLocalUpdates extends VMP {
    ...
    public void init(){
        CompoundVector posteriorOLD = this.plateuStructure.getParameterVariablesPosterior();
        CompoundVector posteriorNew = this.plateuStructure.getParameterVariablesPosterior();
        ...
        this.plateuStructure.updateParameterVariablesPosterior(posteriorNew);
