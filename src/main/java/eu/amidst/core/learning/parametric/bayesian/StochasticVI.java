...
public class StochasticVI implements BayesianParameterLearningAlgorithm, Serializable {
    ...
    protected eu.amidst.core.learning.parametric.bayesian.SVB svb;
    ...
    public eu.amidst.core.learning.parametric.bayesian.SVB getSVB() {
        return svb;
    }
    ...
    public void initLearning() {
        ...
        initialPosterior = Serialization.deepCopy(this.svb.getPlateuStructure().getParameterVariablesPosterior());
