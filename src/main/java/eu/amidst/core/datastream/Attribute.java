...
public final class Attribute implements Serializable {
    ...
    public boolean isDiscrete() {
        return this.stateSpaceType.getStateSpaceTypeEnum() == StateSpaceTypeEnum.FINITE_SET;
    }

    public boolean isContinuous() {
        return this.stateSpaceType.getStateSpaceTypeEnum() == StateSpaceTypeEnum.REAL;
    }

    public boolean isSparseDiscrete() {
        return this.stateSpaceType.getStateSpaceTypeEnum() == StateSpaceTypeEnum.SPARSE_FINITE_SET;
    }
}