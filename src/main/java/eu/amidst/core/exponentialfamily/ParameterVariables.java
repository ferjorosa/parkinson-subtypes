...
public class ParameterVariables implements Iterable<Variable>, Serializable {
    ...
    private static class ParameterVariable implements Variable, Serializable {
        ...
        public ParameterVariable(ParameterVariable parameterVariable) {
            this.name = parameterVariable.name;
            this.varID = parameterVariable.varID;
            this.observable = parameterVariable.observable;
            this.stateSpaceType = parameterVariable.stateSpaceType;
            this.numberOfStates = parameterVariable.numberOfStates;
            this.distributionTypeEnum = parameterVariable.distributionTypeEnum;
        ...
        public int hashCode(){
            ...
            // Extra: le pongo los mismos parametros al HashCodeBuilder que en Variables porque el equals diria OK
            // pero si no hago esto el hashcode diria not OK
        ...
        @Override
        public ParameterVariable deepCopy() {
            return new ParameterVariable(this);
        }
