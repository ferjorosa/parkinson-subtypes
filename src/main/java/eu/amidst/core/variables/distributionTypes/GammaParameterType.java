...
public class GammaParameterType extends DistributionType {
    ...
    public EF_Gamma newEFUnivariateDistribution() {
        return new EF_Gamma(this.variable);
    }

    /**
     * Creates a Gamma distribution with a specific set of moment parameters
     * @return an exponential family Gamma distribution
     */
    @Override
    public EF_Gamma newEFUnivariateDistribution(double[] parameters) {
        return new EF_Gamma(this.variable, parameters);
    }
